...
header("Content-Security-Policy: default-src 'self'; style-src 'self' https://cdn.jsdelivr.net 'unsafe-inline'; script-src 'self' https://cdn.jsdelivr.net 'unsafe-inline' blob: 'wasm-unsafe-eval' https://unpkg.com; img-src 'self' data: https://generativelanguage.googleapis.com; font-src 'self' https://cdn.jsdelivr.net; connect-src 'self' https://generativelanguage.googleapis.com https://cdn.jsdelivr.net https://tessdata.projectnaptha.com https://unpkg.com; worker-src 'self' blob:; object-src 'none'; frame-ancestors 'self';");
